...
class HomeModel extends CI_Model {
    ...
    var $table = 'pemesanan';
    var $column_order = array(null, 'id_pemesanan', 'total_harga', 'diskon', '(total_harga-diskon)', 'status', 'tgl_ubah'); //set column field database for datatable orderable
    var $column_search = array('CONCAT("NOTA-", id_pemesanan)', 'total_harga', 'diskon', '(total_harga-diskon)', 'status', 'tgl_ubah'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    private function _get_datatables_query()
    {
		...
		$this->db->where(array('id_user' => $this->session->userdata('idUser'), 'DATE(tgl_ubah)' => date('Y-m-d')));
